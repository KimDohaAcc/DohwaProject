<template>
  <div class="search-bar">
    <div class="search-options">
      <button :style="{ backgroundColor: store.type === 'board' ? '#ff6961' : '' }" @click="selectType('board')">이용
        후기</button>
      <button :style="{ backgroundColor: store.type === 'video' ? '#ff6961' : '' }"
        @click="selectType('video')">비디오</button>
    </div>
